                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                                Focus on highlighting your dedication to quality
                                and customer satisfaction in car washing and
                                detailing.
                            </p>
                            <ul>
                                <li>
                                    <i class="far fa-check-circle"></i>Seats
                                    washing
                                </li>
                                <li>
                                    <i class="far fa-check-circle"></i>Vacuum
                                    cleaning
                                </li>
                                <li>
                                    <i class="far fa-check-circle"></i>Interior
                                    wet cleaning
                                </li>
                                <li>
                                    <i class="far fa-check-circle"></i>Window
                                    wiping
                                </li>
                            </ul>
